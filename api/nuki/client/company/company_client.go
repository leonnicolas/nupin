...
func (a *Client) CompaniesResourceGetGet(params *CompaniesResourceGetGetParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CompaniesResourceGetGetOK, error) {
	...
	if params == nil {
		params = NewCompaniesResourceGetGetParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "CompaniesResource_get_get",
		Method:             "GET",
		PathPattern:        "/company",
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &CompaniesResourceGetGetReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*CompaniesResourceGetGetOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for CompaniesResource_get_get: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
