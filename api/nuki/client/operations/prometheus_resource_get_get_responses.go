...
func (o *PrometheusResourceGetGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPrometheusResourceGetGetOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /metrics] PrometheusResource_get_get", response, response.Code())
	}
}
...
func NewPrometheusResourceGetGetOK() *PrometheusResourceGetGetOK {
	return &PrometheusResourceGetGetOK{}
}
...
func (o *PrometheusResourceGetGetOK) Error() string {
	return fmt.Sprintf("[GET /metrics][%d] prometheusResourceGetGetOK  %+v", 200, o.Payload)
}
...
func (o *PrometheusResourceGetGetOK) GetPayload() *models.Representation {
	return o.Payload
}

func (o *PrometheusResourceGetGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.Representation)
