...
func (m *ConnegService) validateContext(formats strfmt.Registry) error {
...
func (m *ConnegService) contextValidateContext(ctx context.Context, formats strfmt.Registry) error {
