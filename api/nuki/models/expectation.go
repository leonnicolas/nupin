...
func (m *Expectation) validateParameters(formats strfmt.Registry) error {
...
func (m *Expectation) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
