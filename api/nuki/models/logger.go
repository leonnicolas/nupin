		...
		if m.Handlers[i] != nil {
			if err := m.Handlers[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("handlers" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if m.ResourceBundle != nil {
		if err := m.ResourceBundle.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("resourceBundle")
			}
			return err
		}
	}
...
func (m *Logger) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateHandlers(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateResourceBundle(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Logger) contextValidateHandlers(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.Handlers); i++ {
		...
		if m.Handlers[i] != nil {
			...
			if err := m.Handlers[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("handlers" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("handlers" + "." + strconv.Itoa(i))
...
func (m *Logger) contextValidateLevel(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Logger) contextValidateParent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Logger) contextValidateResourceBundle(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.ResourceBundle != nil {
		...
		if err := m.ResourceBundle.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("resourceBundle")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("resourceBundle")
