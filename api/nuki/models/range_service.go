...
func (m *RangeService) validateContext(formats strfmt.Registry) error {
...
func (m *RangeService) contextValidateContext(ctx context.Context, formats strfmt.Registry) error {
