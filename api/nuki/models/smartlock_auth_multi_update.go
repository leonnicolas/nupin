...
func (m *SmartlockAuthMultiUpdate) validateAllowedFromDate(formats strfmt.Registry) error {
...
func (m *SmartlockAuthMultiUpdate) validateAllowedUntilDate(formats strfmt.Registry) error {
...
func (m *SmartlockAuthMultiUpdate) validateAllowedWeekDays(formats strfmt.Registry) error {
...
func (m *SmartlockAuthMultiUpdate) validateID(formats strfmt.Registry) error {
...
func (m *SmartlockAuthMultiUpdate) validateName(formats strfmt.Registry) error {
...
func (m *SmartlockAuthMultiUpdate) UnmarshalBinary(b []byte) error {
	var res SmartlockAuthMultiUpdate
